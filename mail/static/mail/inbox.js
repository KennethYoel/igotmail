document.addEventListener("DOMContentLoaded", function () {
  ...
  // Add event listener to the email form
...
function load_mailbox(mailbox, message = "") {
  // If any messages delete it
  document.querySelector("#message-box").textContent = "";

  // If any messages then print to screen.
  if (message !== "") {
    make_alert(message);
  }
...
function make_alert(message) {
  ...
  document.querySelector("#message-box").appendChild(element);
}
